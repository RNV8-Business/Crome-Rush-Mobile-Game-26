(() => {
  ...
  const carSpecs = {
    ...
    huracan: makeCar('LAMBORGHINI HURACAN', 'huracan', 11, 10),
    ...
    slrMclaren: makeCar('MERCEDES SLR MCLAREN', 'slr_mclaren', 12, 10),
    carreraGT: makeCar('PORSCHE CARRERA GT', 'carrera_gt', 12, 11),
    ferrari288: makeCar('FERRARI 288 GTO', 'ferrari_288', 12, 0, 'fourFerraris'),
    f40: makeCar('FERRARI F40', 'f40', 13, 13),
    astonOne77: makeCar('ASTON MARTIN ONE-77', 'aston_one77', 14, 0, 'f40BigDilf500'),
    f50: makeCar('FERRARI F50', 'f50', 14.5, 14),
    ...
    jesko: makeCar('KOENIGSEGG JESKO', 'jesko', 15, 15),
    ...
    enzo: makeCar('FERRARI ENZO', 'enzo', 16, 15),
    mc12: makeCar('MASERATI MC12', 'mc12', 16, 16),
    slrStirling: makeCar('SLR STIRLING MOSS', 'slr_stirling', 17, 18),
    ...
    laferrari: makeCar('FERRARI LAFERRARI', 'laferrari', 19, 20),
    ...
    amgOne: makeCar('MERCEDES AMG ONE', 'amg_one', 21, 22),
    astonValkyrie: makeCar('ASTON MARTIN VALKYRIE', 'aston_valkyrie', 22, 0, 'astonValkyrieBlack35'),
    yangwangU9: makeCar('BYD YANGWANG U9', 'yangwang_u9', 23, 23),
    chiron: makeCar('BUGATTI CHIRON', 'chiron', 24, 25),
    bugattiTourbillon: makeCar('BUGATTI TOURBILLON CR7', 'bugatti_tourbillon', 25, 0, 'cr7Chiron850'),
    f80: makeCar('FERRARI F80', 'f80', 25, 25),
  ...
  function getCarChallengeState(type) {
    ...
    switch (key) {
      ...
      case 'everyMercedes': {
        const cars = ['mercedes300sl', 'mercedesGle', 'slrMclaren', 'slrStirling', 'amgOne'];
      ...
      case 'everyBugatti': {
        const cars = ['chiron', 'bugattiVeyron', 'bugattiTourbillon', 'bugattiEb1'];
